...
console.log("Random number between 1-10:");
...
const deficit = -150;
console.log("Absolute value of -150:");
// Write abs code here - Output: 150
console.log(Math.abs(deficit));

const distance = -42.5;
console.log("Absolute value of -42.5:");
...
const base = 2;
const exponent = 3;
console.log("2 to the power of 3:");
...
// Write your code here
console.log(Math.ceil(testPrice));
